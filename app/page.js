...
export default function Home() {
  ...
  const handleClick = () => {
    setLoader(true);
    router.push("/signup");
    // no need to reset loader; navigation changes page
  };
  ...
  return (
    <>
      ...
      <div className="flex justify-center min-w-screen items-center text-center h-[44vh] gap-2 flex-col text-white">
        <div className="font-bold flex w-full items-center justify-center text-2xl md:text-3xl">
          Get Me a Chai{" "}
          <span>
            <Image src="/tea.gif" alt="Tea" width={88} height={88} />
          </span>
        </div>
        <p className="text-gray-200 px-2 md:px-0">
        ...
        <div className="flex items-center justify-center gap-4 mt-2 flex-row">
          <button
            type="button"
            className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-xl px-4 py-2.5 text-center leading-5"
          >
            Read More
          </button>
          <button
      ...
      <div className="p-5">
        ...
        <div className="flex items-center flex-wrap justify-center gap-12 mt-8 mb-8">
          <div className="flex flex-col items-center justify-center gap-2 text-white">
            <Image src="/coin.gif" alt="Coin" width={150} height={150} />
            <h1 className="font-bold">Fund Yourself</h1>
            <p className="text-gray-200">Your fans are available for your support.</p>
          </div>
          <div className="flex flex-col items-center justify-center gap-2 text-white">
            <Image src="/man.gif" alt="Man" width={150} height={150} />
            <h1 className="font-bold">Fund Yourself</h1>
            <p className="text-gray-200">Your fans are available for your support.</p>
          </div>
          <div className="flex flex-col items-center justify-center gap-2 text-white">
            <Image src="/group.gif" alt="Group" width={150} height={150} />
            <h1 className="font-bold">Fund Yourself</h1>
            <p className="text-gray-200">Your fans are available for your support.</p>
          </div>
        </div>
